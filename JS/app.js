...
let hight = prompt('Is my hight more than 180cm? ');
// console.log(hight);


while (hight !== 'yes' && hight !== 'y' && hight !== 'no' && hight !== 'n') {
    hight = prompt('please enter only yes/no or y/n');
}

switch (hight.toLocaleLowerCase()) {
    case 'yes':
    case 'y':
        alert('you\'re correct, my hight is 190cm :D ');
        break;
...
alert('Thank you ' + userName + ', you can take a look to my page now.');
